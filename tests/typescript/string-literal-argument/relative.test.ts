...
export function Foo({ children }) {
  return (
    <div className={classNames('lorem ipsum dolor sit amet')}>
      {children}
    </div>
  );
}
...
export function Foo({ children }) {
  return (
    <div className={classNames('lorem ipsum dolor sit amet consectetur adipiscing elit proin')}>
      {children}
    </div>
  );
}
...
export function Foo({ children }) {
  return (
    <div className={classNames('lorem ipsum dolor sit amet consectetur adipiscing elit proin ex massa hendrerit eu posuere eu volutpat id neque pellentesque')}>
      {children}
    </div>
  );
}
