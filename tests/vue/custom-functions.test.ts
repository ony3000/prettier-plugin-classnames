...
`,
  ...
  {
    name: 'typescript in template (custom function #1)',
    input: `
<script setup lang="ts">
import clsx from 'clsx'
</script>
...
<template>
  <div :class="clsx('rounded-xl border border-zinc-400/30 bg-gray-100/50 px-4 py-4 dark:border-neutral-500/30 dark:bg-neutral-900/50' as string)">
    <slot></slot>
  </div>
</template>
`,
